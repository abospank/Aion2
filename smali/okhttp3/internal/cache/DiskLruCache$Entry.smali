...
.method public final snapshot$okhttp()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    .line 90
    .line 91
    invoke-interface {v3, v4}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lst0;
...
.method public final writeLengths$okhttp(Le9;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p1, v5}, Le9;->writeByte(I)Le9;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Le9;->I(J)Le9;
