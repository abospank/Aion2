...
.method public constructor <init>(Lf9;)V
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:Lf9;
...
.method private final readContinuationHeader()V
    ...
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:Lf9;

    invoke-static {v1}, Lokhttp3/internal/Util;->readMedium(Lf9;)I
    ...
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:Lf9;
    ...
    :cond_0
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:Lf9;

    invoke-interface {v2}, Lf9;->readInt()I
...
.method public read(Lz8;J)J
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:Lf9;

    iget v3, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->padding:I

    int-to-long v3, v3

    invoke-interface {v0, v3, v4}, Lf9;->skip(J)V
    ...
    invoke-interface {v3, p1, p2, p3}, Lst0;->read(Lz8;J)J
