...
.method public static constructor <clinit>()V
    ...
    new-instance v1, Lorg/videolan/libvlc/util/HWDecoderUtil$AudioOutput;

    const-string v3, "AUDIOTRACK"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lorg/videolan/libvlc/util/HWDecoderUtil$AudioOutput;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lorg/videolan/libvlc/util/HWDecoderUtil$AudioOutput;->AUDIOTRACK:Lorg/videolan/libvlc/util/HWDecoderUtil$AudioOutput;

    new-instance v3, Lorg/videolan/libvlc/util/HWDecoderUtil$AudioOutput;

    const-string v5, "ALL"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lorg/videolan/libvlc/util/HWDecoderUtil$AudioOutput;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lorg/videolan/libvlc/util/HWDecoderUtil$AudioOutput;->ALL:Lorg/videolan/libvlc/util/HWDecoderUtil$AudioOutput;

    const/4 v5, 0x3

    new-array v5, v5, [Lorg/videolan/libvlc/util/HWDecoderUtil$AudioOutput;
    ...
    sput-object v5, Lorg/videolan/libvlc/util/HWDecoderUtil$AudioOutput;->$VALUES:[Lorg/videolan/libvlc/util/HWDecoderUtil$AudioOutput;
