...
.method public static constructor <clinit>()V
    ...
    const-string v3, "SURFACE_FIT_SCREEN"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lorg/videolan/libvlc/MediaPlayer$ScaleType;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lorg/videolan/libvlc/MediaPlayer$ScaleType;->SURFACE_FIT_SCREEN:Lorg/videolan/libvlc/MediaPlayer$ScaleType;

    new-instance v3, Lorg/videolan/libvlc/MediaPlayer$ScaleType;

    const-string v5, "SURFACE_FILL"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lorg/videolan/libvlc/MediaPlayer$ScaleType;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lorg/videolan/libvlc/MediaPlayer$ScaleType;->SURFACE_FILL:Lorg/videolan/libvlc/MediaPlayer$ScaleType;

    new-instance v5, Lorg/videolan/libvlc/MediaPlayer$ScaleType;

    const-string v7, "SURFACE_16_9"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lorg/videolan/libvlc/MediaPlayer$ScaleType;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lorg/videolan/libvlc/MediaPlayer$ScaleType;->SURFACE_16_9:Lorg/videolan/libvlc/MediaPlayer$ScaleType;

    new-instance v7, Lorg/videolan/libvlc/MediaPlayer$ScaleType;

    const-string v9, "SURFACE_4_3"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lorg/videolan/libvlc/MediaPlayer$ScaleType;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lorg/videolan/libvlc/MediaPlayer$ScaleType;->SURFACE_4_3:Lorg/videolan/libvlc/MediaPlayer$ScaleType;

    new-instance v9, Lorg/videolan/libvlc/MediaPlayer$ScaleType;

    const-string v11, "SURFACE_ORIGINAL"

    const/4 v12, 0x5

    invoke-direct {v9, v11, v12}, Lorg/videolan/libvlc/MediaPlayer$ScaleType;-><init>(Ljava/lang/String;I)V

    sput-object v9, Lorg/videolan/libvlc/MediaPlayer$ScaleType;->SURFACE_ORIGINAL:Lorg/videolan/libvlc/MediaPlayer$ScaleType;

    const/4 v11, 0x6

    new-array v11, v11, [Lorg/videolan/libvlc/MediaPlayer$ScaleType;
    ...
    sput-object v11, Lorg/videolan/libvlc/MediaPlayer$ScaleType;->$VALUES:[Lorg/videolan/libvlc/MediaPlayer$ScaleType;
