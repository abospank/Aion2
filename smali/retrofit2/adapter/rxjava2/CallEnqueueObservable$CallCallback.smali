...
.field private final observer:Lkh0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lkh0<",
            "-",
...
# direct methods
.method public constructor <init>(Lretrofit2/Call;Lkh0;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Lretrofit2/adapter/rxjava2/CallEnqueueObservable$CallCallback;->observer:Lkh0;
...
.method public onFailure(Lretrofit2/Call;Ljava/lang/Throwable;)V
    ...
    :cond_0
    :try_start_0
    iget-object p1, p0, Lretrofit2/adapter/rxjava2/CallEnqueueObservable$CallCallback;->observer:Lkh0;
    ...
    invoke-direct {v0, v1}, Led;-><init>([Ljava/lang/Throwable;)V
...
.method public onResponse(Lretrofit2/Call;Lretrofit2/Response;)V
    ...
    :try_start_0
    iget-object v0, p0, Lretrofit2/adapter/rxjava2/CallEnqueueObservable$CallCallback;->observer:Lkh0;

    invoke-interface {v0, p2}, Lkh0;->onNext(Ljava/lang/Object;)V
    ...
    iget-object p2, p0, Lretrofit2/adapter/rxjava2/CallEnqueueObservable$CallCallback;->observer:Lkh0;

    invoke-interface {p2}, Lkh0;->onComplete()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-interface {v0, p2}, Lkh0;->onError(Ljava/lang/Throwable;)V
    :try_end_1
    ...
    invoke-direct {v1, v2}, Led;-><init>([Ljava/lang/Throwable;)V
